        ...
        <>
            <div className="bg-black grid sm:grid-cols-1 lg:grid-cols-3 py-16 px-16 gap-10">
                <div className="grid justify-items-start">
                    ...
                    <Link to='mailto:isrealitycreations@gmail.com' target="_blank" className="bt bg-primary py-4 px-16 ml-0 text-white rounded-full hover:border-2 border-primary">Contact</Link>
                </div>
                ...
                <div className="justify-items-start">
                    <h4 className="text-white text-left font-bold text-2xl mb-4">Contact Info</h4>
                    <p className="text-white text-left text-xl mb-4">isrealitycreations@gmail.com</p>
                    <p className="text-white text-left text-xl mb-4">+2348140082953</p>                   
                </div>
            </div>
        </> 
