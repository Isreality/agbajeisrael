                ...
                <Link to={props.link} target="_blank">
                    <img className='h-125 w-full object-cover hover:scale-105' src={props.image} alt=""></img>
                        <div className="px-0 md:px-8 py-4 md:py-8">
                            <div className="flex justify-between items-center py-2 px-2 mb-0 md:mb-2">
                                    <h2 className="text-primary text-lg md:text-4xl font-bold">{props.header}</h2>
                            ...
                            <div className="px-2">   
                                <p className="text-white text-justify md:text-justify text-xs md:text-lg font-light">{props.text}</p>
                            </div>
                        </div>
                </Link>
