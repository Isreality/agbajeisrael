                    ...
                    <div className="pro py-4 md:py-8">
                        <div className="flex flex-col px-20 gap-0 md:gap-40">
                            ...
                            <div className="flex flex-col items-center lg:items-start py-0 gap-0">
                                ...
                                <p className="text-white text-center lg:text-left text-sm md:text-xl mb-1">A Graphic Designer, Product Designer & Illustrator.</p><br/>
                                <Link to='https://drive.google.com/file/d/1jociKuMGT0lWljKHCTgygnjgahaN187Y/view?usp=drive_link' target="_blank" className="bg-primary py-4 px-8 text-white rounded-full font-medium hover:bg-transparent hover:text-white hover:border-2 border-white">View Resume</Link>
                                </Fade>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col px-2 justify-start">
                            ...
                            <div className="flex flex-col md:flex-row gap-3 text-white text-left">
                                ...
                                <div className="bg-shade px-4 md:px-8 py-4 rounded-md">
                                    ...
                                    <p className="text-base md:text-lg">Projects</p>
                                </div>
                            </div>
                        </div>  
